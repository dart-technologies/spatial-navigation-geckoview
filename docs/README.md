...
Reference and guides for `@dart-technologies/spatial-navigation-geckoview`.
Start at the [project README](../README.md) for features, install, and usage.
...
| [PRESETS.md](PRESETS.md)             | `applyPreset()` form-factor profiles (tv / phone / tablet / kiosk).        |
| [MIGRATION.md](MIGRATION.md)         | Version-to-version upgrade notes, newest first.                            |
